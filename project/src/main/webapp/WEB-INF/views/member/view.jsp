	...
	<div id="header">
	 ...
	 <section class="page-section" id="register">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">이게 나야</h2>
                <!-- Icon Divider-->
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form method="post" action="/member/register" id="contactForm">
                            ...
                            <div class="form-floating mb-3">
                             ...
                             <div class="form-floating mb-3">
                                <input class="form-control" type="text" name="pw" id="pw" value="${member.pw}" readonly/>
...
<!--                                 <label for="phone">Phone number</label>
                   			...
                   			<input class="btn btn-primary btn-xl" id="submitButton" type="button">정보 수정
                   			<input class="btn btn-primary btn-xl" id="submitButton" type="submit">회원 탈퇴
